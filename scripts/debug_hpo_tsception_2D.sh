...
apptainer run --nv -B /tmp/hpo_best_pvc_debug.sqfs:/input-data:image-src=/ ./../env_images/bbcpy_en.sif python ./src/dnn_hpo_train.py experiment=2_Tsception_2D +data.subject_sessions_dict='{S5: "all", S9:"all"}' hparams_search=2_tsception_optuna logger.mlflow.run_name="best-2-pvc"