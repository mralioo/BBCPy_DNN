...
apptainer run --nv -B /tmp/S6.sqfs:/input-data:image-src=/ ./../env_images/bbcpy_lightning_v5.sif python ./src/dnn_train.py experiment=eegnet +data.subject_sessions_dict="{S6: "all"}"
