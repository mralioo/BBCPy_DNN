...
if __name__ == "__main__":
    ...
    num_samples = 10
    model = TSception(num_classes=2, input_size=(62, 6000), sampling_rate=256, num_T=9, num_S=6, hidden=128,
                      dropout_rate=0.2).double()
    input = Variable(torch.from_numpy(np.random.rand(1, 1, 62, 6000))).double()
