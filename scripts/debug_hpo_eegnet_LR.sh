...
apptainer run --nv -B /tmp/hpo_best_pvc_debug.sqfs:/input-data:image-src=/ ./../env_images/bbcpy_en.sif python ./src/dnn_hpo_train.py experiment=1_eegnet_LR +data.subject_sessions_dict='{S5: "all", S9:"all"}' hparams_search=1_eegnet_optuna logger.mlflow.run_name="C1-m-LR"
