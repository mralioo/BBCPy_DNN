...
#SBATCH --nodelist=head034-head035
...
apptainer run --nv -B /tmp/hpo_best_pvc_debug.sqfs:/input-data:image-src=/ ./../env_images/bbcpy_en.sif python ./src/dnn_hpo_train.py experiment=2_Tsception_LR +data.subject_sessions_dict='{S5: "all", S9:"all"}' hparams_search=2_tsception_optuna logger.mlflow.run_name="LR-best-2-pvc"